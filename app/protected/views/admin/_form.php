...
<?php $form=$this->beginWidget('booster.widgets.TbActiveForm', array(
	...
	<?php //echo $form->errorSummary($model); ?>
		...
		<?php echo $form->passwordFieldGroup($model,'password',array('size'=>60,'maxlength'=>240)); ?>
		<?php echo $form->passwordFieldGroup($model,'confirm_password',array('size'=>60,'maxlength'=>240)); ?>
	...
	<?php $this->widget(
    		...
    		array('buttonType' => 'submit', 'label' => $model->isNewRecord ? 'Add New Admin' : 'Update')
		);?>
