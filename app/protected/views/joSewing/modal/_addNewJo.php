<?php //modal pop-up form for Adding new jo 
  	//Yii::app()->booster->registerAssetCss('bootstrap-datepicker.css');
	//Yii::app()->booster->registerAssetJs('bootstrap.datepicker.js');
?>
...
<div class="modal-body" style="position: relative;">
    ...
    'focus'=>array($model,'jo'),
		...
		<?php echo $form->select2Group($model,'delivery_receipt', 
							array(
								'widgetOptions'=>array(
									'data'=> $options['Delivery_Receipt'], 
									'options'=>array(
